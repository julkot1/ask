...
znaleźć w tekstach 1998 \cite{1}. Pomimo starości nadal jest jednym z najczęściej stosowanych sposobów ataków na witryny.
...
Witryny, na których możliwe jest przeprowadzenie tak łatwego wstrzyknięcia są dość rzadkie. W tym projekcie nacisk jest położony na
...
Znając zapytanie, dla którego wynikiem jest rezultat "sukces", jeżeli do zapytania dodany
...
to podatność występuje jeśli dla zapytania \verb|alice' AND 'a'='b| rezultatem jest "porażka", jako iż wyrażenie \verb|(dowolne zdanie logiczne) AND 'a' = 'b'|
zawsze zwróci fałsz.
